How to contribute to Listo
==========================

Thank you for considering contributing to Listo. This document explains how you can contribute to the project. We ask all contributors to read through this first.


Contributing by reporting issues
--------------------------------

If you find a bug, please report it to our [GitHub repository](https://github.com/rocklobster-in/listo) unless it is about a security vulnerability. Creating an issue is always recommended, but for minor issues like correction of a typo, you can create a pull request instead of an issue.
...
Receiving reports of issues that have little to do with the plugin negatively impacts the motivation of the developers. If you are uncertain, posting to the [support forum](https://wordpress.org/support/plugin/listo/) is advised.
...
Everyday, a lot of users come to the [official support forum](https://wordpress.org/support/plugin/listo/) to post their support requests. If you feel you can answer their questions, please do not hesitate to do so.
...
We use [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/listo/) (GlotPress) to manage translations for the plugin. This is a collaborative translation platform in which thousands of volunteer translators participate.
...
Listo is released under the GNU General Public License (GPL), and copyrights are protected. Please use this plugin while respecting the intellectual property rights.
